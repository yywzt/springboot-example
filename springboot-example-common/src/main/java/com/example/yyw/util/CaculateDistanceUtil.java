...
public class CaculateDistanceUtil {
    ...
    public static void main(String[] args)
    {
        ...
        // 112.76535,22.75424  113.10111,23.014171
        source = new GlobalCoordinates(22.75424, 112.76535);
        target = new GlobalCoordinates(23.014171, 113.10111);

        meter1 = getDistanceMeter(source, target, Ellipsoid.Sphere);
        meter2 = getDistanceMeter(source, target, Ellipsoid.WGS84);
